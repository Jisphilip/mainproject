...
public class Cust_images extends ArrayAdapter<String>  {

    private Activity context;       //for to get current activity context
    SharedPreferences sh;
    private String[] image,title,file_type,date;


    public Cust_images(Activity context, String[] image, String[] title, String[] file_type, String[] date) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        t2.setText("File Type : " + file_type[position]);
